        ...
        <!-- partial -->
          ...
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> EEE Students </h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">EEE Students</h4>
...
<?php
     include('includes/dbconnection.php');
$sql = "SELECT * FROM tblstudent WHERE StudentClass = '5'";
