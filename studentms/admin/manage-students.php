...
$sql="SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.DateofAdmission,tblclass.ClassName,tblstudent.status,tblstudent.principalstatus,tblclass.Section from tblstudent join tblclass on tblclass.ClassName=tblstudent.StudentClass LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);

$cnt=1;
?>   <form action="search_student_issue.php" method="post">
Select Date: <input type="date" name="search_date"><br>
<input type="submit" value="Search Student Issues">
</form>  <?php
if($query->rowCount() > 0)
{
