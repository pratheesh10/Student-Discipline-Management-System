...
<html lang="en">
  <head>
    ...
    <title>Student  Discipline System|| Add Students</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Student Issue</label>
                        <input type="text" name="stuemail" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Evidence</label>
...
<option value="<?php echo htmlentities($row1->ClassName);?>"><?php echo htmlentities($row1->ClassName);?> </option>
 <?php } ?> 
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" name="password" value="student" class="form-control" required='true'>
                      </div>
